...
- Filtering and sorting in the library grid view and catalogs ​
- Major technical upgrade improving speed and stability ​
- Corrected heading hierarchy and smoother keyboard navigation​
- Fixes including MathML support, LCP passphrase display option, improved note handling
